    ...
    render(){
        ...
        return(
            <View style={[Loginscreen.container, { padding: 50  , }]}>
                ...
                <Image style={{width:70,marginBottom:40,marginTop:110, height: 70,}} source={require('../recursos/img/vendon.png')} />
                ...
                <TouchableOpacity style={Loginscreen.loginBtn} onPress={() => this.goToScreen('Home')}>
